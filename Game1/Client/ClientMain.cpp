...
void main()
{
	...
	SBR::i3fP3fN2fT::Model* model = mesh->To_i3fP3fN2fT_Model();
	...
	SBR::File::Write("Models/Porsche_911.sbm", porscheBuffer, proscheModel->GetSize());
	...
	*pipe = SBM::Matrix4::Scale(12, 12, 12);
	...
	//SBR::VBO* vbo = new SBR::VBO(mesh);
	SBR::VBO* vbo = new SBR::VBO(obj->objObjects[0]->mesh);

	//SBR::OBJ_Object* object = new SBR::OBJ_Object(std::string("Plane"));
	//object->mesh = mesh;

	SBR::Shader* frag = SBR::Loader::Shader("C:/Engine/Content/Shaders/DefaultShader.frag");
